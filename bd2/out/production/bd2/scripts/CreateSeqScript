...
CREATE SEQUENCE sq_fee
    START WITH 1
    INCREMENT BY 1
    NOMAXVALUE;
CREATE SEQUENCE sq_goods_type
    START WITH 1
    INCREMENT BY 1
    NOMAXVALUE;
CREATE SEQUENCE sq_delivered_goods
    START WITH 1
    INCREMENT BY 1
    NOMAXVALUE;
CREATE SEQUENCE sq_dealers
    START WITH 1
    INCREMENT BY 1
    NOMAXVALUE;
CREATE SEQUENCE sq_delivers
    START WITH 1
    INCREMENT BY 1
    NOMAXVALUE;
CREATE SEQUENCE sq_orders
    ...
    INCREMENT BY 1
    NOMAXVALUE;
CREATE SEQUENCE sq_cells
    START WITH 1
    INCREMENT BY 1
    NOMAXVALUE;
CREATE SEQUENCE sq_sells
    START WITH 1
    INCREMENT BY 1
    NOMAXVALUE;